...
export default class CenterCabin extends Phaser.Scene {

    constructor()
    {
        super({key: 'Center Cabin'});
    }
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("cabinMap", '../Resources/CenterCabin.json');
    ...
    create() {
        ...
        const map = this.make.tilemap({ key: "cabinMap"});
