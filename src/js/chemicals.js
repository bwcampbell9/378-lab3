...
export default class Chemicals extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("chemicalsMap", '../Resources/Chemicals.json');
    ...
    create() {
        ...
        const map = this.make.tilemap({ key: "chemicalsMap"});
