...
export default class GravityRoom extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("gravityRoomMap", '../Resources/GravityRoom.json');
    ...
    create() {
        ...
        const map = this.make.tilemap({ key: "gravityRoomMap"});
