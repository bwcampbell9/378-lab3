...
export default class FirstRoom extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("firstRoomMap", '../Resources/startRoom.json');
    ...
    create() {
        ...
        const map = this.make.tilemap({ key: "firstRoomMap"});
        ...
        this.door = new Door(this.player, this, 22,
            15, 'First Room', 'Center Cabin',
            map);
    }
